...
- **Shadow Mobs**  
  - Wander the map.  
  - Some are aggressive (chase you).  
  - Some are evasive (flee and must be chased).  
...
- **Trainer‑like Characters**  
  ...
  - Cannot be fled from.  
  - Used for scripted encounters, guards, or challenges.  

There are no multi-battlers, they are always 1v1:
...
- Caches present **choices** (e.g., pick 1 of 3 upgrades).  
- Mods apply only during the current run and expire at extraction.  
- Focused on **combat** effects:  
  - Stronger Poison or Burning.  
...
- Each planet has multiple **extraction endpoints**.  
...
Exploration balances **risk vs. reward**:  
- Push deeper into the planet’s zones to discover new creatures, caches, and story.  
- Know when to stop and extract before your Animech is lost.  
- Outposts and settlements provide stability, while shadow mobs and caches keep each run unpredictable.  
